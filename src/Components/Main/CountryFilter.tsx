...
export const CountryFilter = ({region, subregion,onRegionChange, onSubregionChange}: Props) => {
  return (
    <div className="filter-container">
        <select value={region} className="region filter" onChange={(e)=> onRegionChange(e.target.value)}>
        ...
        <select value={subregion} className="filter" onChange={(e)=>onSubregionChange(e.target.value)}>
